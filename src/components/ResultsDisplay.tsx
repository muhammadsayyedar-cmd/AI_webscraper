import { FileText, Clock, TrendingUp, ExternalLink, Download, File, AlertTriangle, Copy, Check, Linkedin, Twitter, Instagram } from 'lucide-react';
...
`;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Social Media Posts */}
      {(data.linkedin_post || data.twitter_post || data.instagram_caption) && (
        <div className="bg-gradient-to-br from-pink-900/20 to-purple-900/20 rounded-xl p-6 border border-pink-500/30">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Ready-to-use content for social platforms</p>
            </div>
          </div>
